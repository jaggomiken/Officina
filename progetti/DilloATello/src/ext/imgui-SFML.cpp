...
bool Init(sf::Window& window, const sf::Vector2f& displaySize, bool loadDefaultFont) {
    ...
    io.Fonts->AddFontFromFileTTF("fonts/Cousine-Regular.ttf", 13);
    io.Fonts->AddFontFromFileTTF("fonts/Cousine-Regular.ttf", 16);
    io.Fonts->AddFontFromFileTTF("fonts/Cousine-Regular.ttf", 18);
    io.Fonts->AddFontFromFileTTF("fonts/Cousine-Regular.ttf", 21);
    io.Fonts->AddFontFromFileTTF("fonts/DroidSans.ttf", 13);
    io.Fonts->AddFontFromFileTTF("fonts/DroidSans.ttf", 16);
    io.Fonts->AddFontFromFileTTF("fonts/DroidSans.ttf", 18);
    io.Fonts->AddFontFromFileTTF("fonts/DroidSans.ttf", 21);
    io.Fonts->AddFontFromFileTTF("fonts/DroidSans.ttf", 24);
    io.Fonts->AddFontFromFileTTF("fonts/Karla-Regular.ttf", 13);
    io.Fonts->AddFontFromFileTTF("fonts/Karla-Regular.ttf", 16);
    io.Fonts->AddFontFromFileTTF("fonts/Karla-Regular.ttf", 18);
    io.Fonts->AddFontFromFileTTF("fonts/Karla-Regular.ttf", 21);
    io.Fonts->AddFontFromFileTTF("fonts/ProggyClean.ttf", 13);
    io.Fonts->AddFontFromFileTTF("fonts/ProggyTiny.ttf", 10);
    ...
    io.Fonts->AddFontFromFileTTF("fonts/Roboto-Medium.ttf", 21);
    io.Fonts->AddFontFromFileTTF("fonts/Roboto-Medium.ttf", 24);
